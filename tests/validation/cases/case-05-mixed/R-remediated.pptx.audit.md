...
- Template (before): `/sessions/jolly-nifty-cori/mnt/Slide Publisher/plugin/tests/validation/cases/case-05-mixed/input.pptx`
- Template (after): `/sessions/jolly-nifty-cori/mnt/Slide Publisher/plugin/tests/validation/cases/case-05-mixed/R-remediated.pptx`
- Remediated: 2026-06-01T22:26:58
...
- **Before:** `Blank`
- **After:** `Comparison`
- **Why:** Renamed to match IR intent 'comparison'. Improves layout_catalog_completeness and reduces orphan_elements.
